...
import com.an.hive.buffer.FieldLengthAggregationBuffer;
...
public class FieldLengthUDAFEvaluator extends GenericUDAFEvaluator {
    ...
    public void reset(AggregationBuffer agg) throws HiveException {
        ((FieldLengthAggregationBuffer)agg).setValue(0L);
    }
    ...
    public void iterate(AggregationBuffer agg, Object[] parameters) throws HiveException {
        ...
        ((FieldLengthAggregationBuffer)agg).add((long) String.valueOf(javaObj).length());
    }
    ...
    public void merge(AggregationBuffer agg, Object partial) throws HiveException {
        ...
        ((FieldLengthAggregationBuffer) agg).add(Long.valueOf((Integer)integerOI.getPrimitiveJavaObject(partial)));
    }
}